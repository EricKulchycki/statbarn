...
export function Footer({ className = '' }: FooterProps) {
  return (
    <footer className={`bg-gray-800 dark:bg-gray-900 text-white border-t border-gray-700 dark:border-gray-600 transition-colors duration-200 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-md font-semibold mb-4 text-white dark:text-white transition-colors duration-200">Quick Links</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-md font-semibold mb-4 text-white dark:text-white transition-colors duration-200">Support</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="/help"
